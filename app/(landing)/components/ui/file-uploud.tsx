...
type TFileUploudProps = {
  onFileSelect?: (file: File | null) => void;
}


const FileUploud = ({onFileSelect}: TFileUploudProps) => {

  // penyimpanan dan menerima file serta null
  ...
  return (
    ...
    className="flex flex-col justify-center items-center w-full py-6 border border-dashed border-primary bg-primary-light">
      ...
      <div className="text-center my-5">
        ...
        <p className="text-xs">Uploud your payment receipt here</p>
      </div>) :(
